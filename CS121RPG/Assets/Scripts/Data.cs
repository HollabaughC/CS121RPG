...
//this is all the data for how the terominos are shaped
public static class Data {

    //needed for handling rotations more easily
    public static readonly float cos = Mathf.Cos(Mathf.PI / 2f);
    public static readonly float sin = Mathf.Sin(Mathf.PI / 2f);
    public static readonly float[] RotationMatrix = new float[] { cos, sin, -sin, cos };

    //defines the initial shapes by painting each tile relative to the origin of the piece
    ...
    //helps with referencing wallkick data
